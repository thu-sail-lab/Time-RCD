...
TOOLKIT = Path("/Users/oliverle/Documents/2024/Huawei/TSB-AD/TSB_AD/models/granite_tsfm/tsfm_public/toolkit")
sys.path.insert(0, str(TOOLKIT))
from .ad_helpers import AnomalyScoreMethods, ScoreListType, TSADHelperUtility
# Now import modules inside 'toolkit'
